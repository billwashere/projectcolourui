...
export const AssoicationList = props => (
    <List {...props} filters={<AssoicationFilter />}>
        <Datagrid>
            ...
            <ReferenceField label="Entity From" source="entitya_id" reference="entity">
                <TextField source="name" />
            </ReferenceField>
...
export const AssoicationEdit = props => (
    <Edit title={<AssoicationTitle />} {...props}>
        <SimpleForm>
            <TextInput source="id" />
            <ReferenceInput label="Assoication Type" source="assoication_type_id" reference="assoication_type">
                <SelectInput optionText="name" />
            </ReferenceInput>
...
export const AssoicationCreate = props => (
    <Create {...props}>
        <SimpleForm>
            ...
            <ReferenceInput label="From Entity" source="entitya_id" reference="entity">
                <SelectInput optionText="name" />
            </ReferenceInput>
